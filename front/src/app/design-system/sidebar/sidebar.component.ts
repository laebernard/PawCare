...
import { LucideUser, LucideImages, LucideCalendar, LucideUsers, LucideDog } from '@lucide/angular';
...
@Component({
  selector: 'ds-sidebar',
  standalone: true,
  imports: [CommonModule, RouterLink, LucideUser, LucideImages, LucideCalendar, LucideUsers, LucideDog],
